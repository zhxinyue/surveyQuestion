<template>
  ...
  <van-radio name="1">A.季度更新</van-radio>
  <van-radio name="2">B.月更新</van-radio>
  <van-radio name="3">C.日更新</van-radio>
  <van-radio name="4">D.其他</van-radio>
</van-radio-group>
<input
          type="text"
          class="box_dec"
       ...
       <div class="question_box">
        ...
        <van-radio-group v-model="radio" direction="horizontal" class="box_checkbox_group">
  <van-radio name="1">A.数据包形式</van-radio>
  <van-radio name="2">B.在线服务形式</van-radio>
  <van-radio name="3" style="width:60%;">C.数据包+在线服务形式</van-radio>
</van-radio-group>
<input
          type="text"
          class="box_dec"
      ...
      <div class="question_box">
        <div class="box_title">
          ...
          <div class="box_text">
            您对四维图新导航地图的<i class="text_underline">现有质量体系</i>方面的满意程度如何？
          </div>
        </div>
        <div class="box_div">
          <div class="box_options">
