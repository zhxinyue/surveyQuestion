...
this.optionVal19 = this.optionVal19 + "" + this.inputVal19;
     ...
     +'-'+this.optionVal12+'-'+this.optionVal13+'-'+this.optionVal14+'-'+this.optionVal15+'-'+this.optionVal16+'-'+
     this.radioValue17+'-'+this.optionVal18+'-'+this.optionVal19+'-'+this.message20
     console.log(str)
